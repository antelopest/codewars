...
function warnTheSheep(queue) {
  let i = queue.indexOf('wolf');
  console.log(i);
  return (i == 0) ? ('Pls go away and stop eating my sheep') :
    (`Oi! Sheep number ${i}! You are about to be eaten by a wolf!`);
}

let arr1 = ["sheep", "sheep", "sheep", "sheep", "sheep", "wolf", "sheep", "sheep"];
let arr2 = [ 'sheep', 'wolf', 'sheep' ];
